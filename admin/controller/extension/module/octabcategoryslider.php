...
class ControllerExtensionModuleOctabcategoryslider extends Controller {
	...
	public function index() {
		...
		$data['entry_first_image'] = $this->language->get('entry_first_image');
		$data['entry_second_image'] = $this->language->get('entry_second_image');
		...
		if (isset($this->request->post['image2']) && is_file(DIR_IMAGE . $this->request->post['image2'])) {
			$data['thumb2'] = $this->model_tool_image->resize($this->request->post['image2'], 50, 50);
            $data['image2'] = $this->request->post['image2'];
        } elseif (!empty($module_info) && isset($module_info['image2'])) {
			$data['thumb2'] = $this->model_tool_image->resize($module_info['image2'], 50, 50);
            $data['image2'] = $module_info['image2'];
        } else {
			$data['thumb2'] = $this->model_tool_image->resize('no_image.png', 50, 50);
            $data['image2'] = 'no_image.png';
        }
