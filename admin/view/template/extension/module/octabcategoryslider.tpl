    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-octabcategoryslider" class="form-horizontal">
		  ...
		  <!-- <div class="form-group">
              <label class="col-sm-2 control-label" for="input-image1"><?php //echo $entry_first_image; ?></label>
              <div class="col-sm-10">
		  ...
		  <div class="form-group">
              <label class="col-sm-2 control-label" for="input-image2"><?php //echo $entry_second_image; ?></label>
              <div class="col-sm-10">
                  <a href="" id="thumb-image2" data-toggle="image" class="img-thumbnail"><img src="<?php //echo $thumb2; ?>" alt="" title=""  /></a>
