...
<script type="text/javascript">
	...
	$('.countdown-product-inner').owlCarousel({
		...
		afterInit : function(el){   
		   $('.occountdown_module .owl-controls .owl-buttons > div.owl-prev').css('left',$('.occountdown_module .owl-item').width()+35);
		   $('.occountdown_module .owl-controls .owl-buttons > div.owl-next').css('right',$('.occountdown_module .owl-item').width()+35);   
		  },
		  afterAction: function(){
		   $('.occountdown_module .owl-wrapper .visible-item').removeClass('visible-item');
		   $('.occountdown_module .owl-wrapper .active:first').addClass('visible-item');
		   $('.occountdown_module .owl-wrapper .active:last').addClass('visible-item');
		  },
	});
