...
$_['text_dimension']    = 'Kích thước  (rộng x dài x cao)';
$_['text_compare']      = 'So sánh sản phẩm (%s)';
$_['text_success']      = 'Thành công: Bạn đã thêm sản phẩm <a href="%s">%s</a> vào <a href="%s">so sánh</a>!';
$_['text_remove']       = 'Thành công: Bạn đã cập nhật danh sách so sánh!';
